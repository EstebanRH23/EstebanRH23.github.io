...
THREE.Object3D.call(this);
var textura1 = new THREE.TextureLoader().load('images/light_wood.jpg');
...
this.Plcompleta.position.z=z-1.5;
this.Prcompleta.position.x=x;
this.Prcompleta.position.y=8;
this.Prcompleta.position.z=z+1.5;
...
THREE.Object3D.call(this);
var textura2 = new THREE.TextureLoader().load('images/dark_wood.jpg');
...
function TorreBlanca(x=0,y=0,z=0){
  ...
  var textura1 = new THREE.TextureLoader().load('images/light_wood.jpg');
  var maderablanca = new THREE.MeshLambertMaterial({map:textura1});
  this.actuator = new THREE.Mesh(halconGeo,maderablanca);
...
function TorreNegra(x=0,y=0,z=0){
  ...
  var textura2 = new THREE.TextureLoader().load('images/dark_wood.jpg');
  var maderanegra = new THREE.MeshLambertMaterial({map:textura2});
  this.actuator = new THREE.Mesh(nave1_p,maderanegra);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function PeonBlanco(x=0,y=0,z=0){
  ...
  var textura1 = new THREE.TextureLoader().load('images/light_wood.jpg');
  var maderablanca = new THREE.MeshLambertMaterial({map:textura1});
  this.actuator = new THREE.Mesh(xWingGeo,maderablanca);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function PeonNegro(x=0,y=0,z=0){
  ...
  var textura2 = new THREE.TextureLoader().load('images/dark_wood.jpg');
  var maderanegra = new THREE.MeshLambertMaterial({map:textura2});
  this.actuator = new THREE.Mesh(storm,maderanegra);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function AlfilBlanco(x=0,y=0,z=0){
  ...
  var textura1 = new THREE.TextureLoader().load('images/light_wood.jpg');
  var maderablanca = new THREE.MeshLambertMaterial({map:textura1});
  this.actuator = new THREE.Mesh(r2d2Geo,maderablanca);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function AlfilNegro(x=0,y=0,z=0){
  ...
  var textura2 = new THREE.TextureLoader().load('images/dark_wood.jpg');
  var maderanegra = new THREE.MeshLambertMaterial({map:textura2});
  this.actuator = new THREE.Mesh(nave3_p,maderanegra);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function CaballoBlanco(x=0,y=0,z=0){
  ...
  var textura1 = new THREE.TextureLoader().load('images/light_wood.jpg');
  var maderablanca = new THREE.MeshLambertMaterial({map:textura1});
  this.actuator = new THREE.Mesh(bb8Geo,maderablanca);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function CaballoNegro(x=0,y=0,z=0){
  ...
  this.actuator = new THREE.Mesh(nave2_p,maderanegra);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function ReinaBlanca(x=0,y=0,z=0){
  ...
  var textura1 = new THREE.TextureLoader().load('images/light_wood.jpg');
  var maderablanca = new THREE.MeshLambertMaterial({map:textura1});
  this.actuator = new THREE.Mesh(leiaGeo,maderablanca);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function ReinaNegra(x=0,y=0,z=0){
  ...
  var textura2 = new THREE.TextureLoader().load('images/dark_wood.jpg');
  var maderanegra = new THREE.MeshLambertMaterial({map:textura2});
  this.actuator = new THREE.Mesh(ds,maderanegra);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function ReyBlanco(x=0,y=0,z=0){
  ...
  var textura1 = new THREE.TextureLoader().load('images/light_wood.jpg');
  var maderablanca = new THREE.MeshLambertMaterial({map:textura1});
  this.actuator = new THREE.Mesh(lukeGeo,maderablanca);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function ReyNegro(x=0,y=0,z=0){
  ...
  var textura2 = new THREE.TextureLoader().load('images/dark_wood.jpg');
  var maderanegra = new THREE.MeshLambertMaterial({map:textura2});
  this.actuator = new THREE.Mesh(nave5,maderanegra);
  this.actuator.commands = [];
  this.add(this.actuator);
  this.position.y=y;
  this.position.z=z;
...
function BloqueAzul(x=0,y=0,z=0){
  Agent.call(this,x,y,z);
  var texturaluz = new THREE.TextureLoader().load('images/luzmorada.jpeg');
...
BloqueAzul.prototype.act = function(environment){
  console.log("Torre",torreblanca1.position.z);
  console.log("Peon",peonnegro1.position.z);
...
function BloqueRojo(x=0,y=0,z=0){
  Agent.call(this,x,y,z);
  var texturaluz = new THREE.TextureLoader().load('images/luzroja.jpeg');
...
function BloqueMorado(x=0,y=0,z=0){
  Agent.call(this,x,y,z);
  var texturaluz = new THREE.TextureLoader().load('images/luzazul.jpeg');
...
function BloqueVerde(x=0,y=0,z=0){
  Agent.call(this,x,y,z);
  var texturaluz = new THREE.TextureLoader().load('images/luzverde.jpeg');
...
function init() {
  ////////////////////////////////////////////Escena//////////////////////////////////////////////////////////////////////////////
  var texturaescena = new THREE.TextureLoader().load('images/wallpaper.jpg');
  ...
  /////////////////////////////////////////////////////Luces/////////////////////////////////////////////////////////////////////
  var luzblan= new THREE.PointLight(0xAAAAAA);
  var luzblan2=new THREE.PointLight(0xAAAAAA);
  var luzblan3= new THREE.PointLight(0xAAAAAA);
  ...
  var textura3 = new THREE.TextureLoader().load('images/piso_claro.jpeg');
  var textura4 = new THREE.TextureLoader().load('images/piso_oscuro.jpeg');
  var textura5 = new THREE.TextureLoader().load('images/granito.jpeg');
  ...
  /////////////////////////////////////////Peones/////////////////////////////////////////////////////////////////
  peonblanco1 = new PeonBlanco(20,4,-10);
  peonblanco2 = new PeonBlanco(20,4,-20);
  peonblanco3 = new PeonBlanco(20,4,-30);
  peonblanco4 = new PeonBlanco(20,4,-40);
  peonblanco5 = new PeonBlanco(20,4,-50);
  peonblanco6 = new PeonBlanco(20,4,-60);
  peonblanco7 = new PeonBlanco(20,4,-70);
  peonblanco8 = new PeonBlanco(20,4,-80);
  ...
  peonnegro1 = new PeonNegro(70,7,-10);
  peonnegro2 = new PeonNegro(70,7,-20);
  peonnegro3 = new PeonNegro(70,7,-30);
  peonnegro4 = new PeonNegro(70,7,-40);
  peonnegro5 = new PeonNegro(70,7,-50);
  peonnegro6 = new PeonNegro(70,7,-60);
  peonnegro7 = new PeonNegro(70,7,-70);
  peonnegro8 = new PeonNegro(70,7,-80);
  ...
  /////////////////////////////////////////Alfiles/////////////////////////////////////////////////////////////////
  alfilblanco1 = new AlfilBlanco(10,11,-30);
  alfilblanco2 = new AlfilBlanco(10,11,-60);
  patitas11=new Patitasblancas(10,-30);
  patitas12=new Patitasblancas(10,-60);

  alfilnegro1 = new AlfilNegro(80,5,-30);
  alfilnegro2 = new AlfilNegro(80,5,-60);
  ...
  //escena.add(patitas11,patitas12);
  ////////////////////////////////////////////Caballos/////////////////////////////////////////////////////////////
  ...
  caballonegro1 = new CaballoNegro(80,5,-20);
  caballonegro2 = new CaballoNegro(80,5,-70);
  ...
  //escena.add(patitas13,patitas14);
  ////////////////////////////////////////////Reinas/////////////////////////////////////////////////////////////////
  reinablanca = new ReinaBlanca(10,10,-40);
  patitas15=new Patitasblancas(10,-40);

  reinanegra = new ReinaNegra(80,1,-40);
  patitasn15=new Patitasnegras(80,-40);

  escena.add(reinablanca,reinanegra);
  escena.add(patitas15);
  ///////////////////////////////////////////Reyes////////////////////////////////////////////////////////////////////
  reyblanco = new ReyBlanco(10,10,-50);
  patitas16=new Patitasblancas(10,-50);

  reynegro = new ReyNegro(80,10,-50);
  patitasn16=new Patitasnegras(80,-50);

  escena.add(reyblanco,reynegro);
  escena.add(patitas16);
  /////////////////////////////////////////Bloques////////////////////////////////////////////////////////////////////
